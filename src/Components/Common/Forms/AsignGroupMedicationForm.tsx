...
const AsignGroupMedicationForm: React.FC<AsignGroupMedicationFormProps> = ({ groupId, onSave }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const medicationResponse = await configContext.axiosHelper.create(`${configContext.apiUrl}/medication_package/asign_group_medications/${userLogged.farm_assigned}/${groupId}`, { medications: medicationsData, warehouseSource })
