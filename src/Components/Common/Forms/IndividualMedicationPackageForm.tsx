...
const IndividualMedicationPackageForm: React.FC<IndividualMedicationPackageFormProps> = ({ pigId }) => {
    ...
    const [modals, setModals] = useState({ medicationPackageDetails: false, success: false, error: false });
            ...
            <TabContent activeTab={activeStep}>
                <TabPane id="step-packageSelect-tab" tabId={1}>
                    <div className="d-flex gap-2 mt-4">
                        <div className="w-50">
                            <Label htmlFor="applicationDate" className="form-label">Fecha de extracción</Label>
                            <DatePicker
                                id="applicationDate"
