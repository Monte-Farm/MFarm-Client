...
import IndividualVaccinationPlanForm from "../Forms/IndividualVaccinationPlan";
    ...
    return (
        <>
            ...
            <Modal size="xl" isOpen={modals.medicationPackage} toggle={() => toggleModal("medicationPackage")} backdrop='static' keyboard={false} centered>
                ...
                <ModalBody>
                    <IndividualMedicationPackageForm pigId={pigId ?? ""} onSave={() => { toggleModal('medicationPackage'); fetchMedicalInfo(); }} />
                </ModalBody>
            </Modal>
            ...
            <Modal size="xl" isOpen={modals.asignSingle} toggle={() => toggleModal("asignSingle")} backdrop='static' keyboard={false} centered>
                ...
                <ModalBody>
                    <SingleMedicationForm pigId={pigId ?? ""} onSave={() => { toggleModal('asignSingle'); fetchMedicalInfo(); }} />
                </ModalBody>
            </Modal>
            ...
            <Modal size="xl" isOpen={modals.asignVaccinationPlan} toggle={() => toggleModal("asignVaccinationPlan")} backdrop='static' keyboard={false} centered>
                ...
                <ModalBody>
                    <IndividualVaccinationPlanForm pigId={pigId} onSave={() => { toggleModal('asignVaccinationPlan'); fetchMedicalInfo(); }} />
                </ModalBody>
            </Modal>
