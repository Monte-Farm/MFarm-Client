...
const ViewBoars = () => {
    ...
    const [modals, setModals] = useState({ selectCreationMode: false, createSingle: false, createBatch: false, update: false, viewPDF: false, assignEarTag: false, bulkMedication: false, bulkFeeding: false });
