...
const AREA_COLORS: Record<string, string> = {
    ...
    hospital: 'danger', shipping: 'secondary', exit: 'secondary', sale: 'success',
};
...
const ViewSoldGroups = () => {
    ...
    return (
        <div className="page-content">
            <Container fluid>
                <BreadCrumb title={t('groups.view.titleSold')} pageTitle={t('groups.pageTitle.sold')} />
                    ...
                    <CardBody style={{ display: "flex", flexDirection: "column", height: "100%" }}>
                        {soldGroups.length > 0 ? (
                            ...
                            <div style={{ flex: 1, display: "flex", justifyContent: "center", alignItems: "center", textAlign: "center", color: "#6c757d", padding: "2rem", flexDirection: "column" }}>
                                ...
                                <h5 style={{ marginBottom: 6 }}>{t('groups.empty.noSold')}</h5>
                                <p style={{ maxWidth: 360, margin: 0, fontSize: 15 }}>
                                    {t('groups.empty.noSoldMsg')}
                                </p>
                            </div>
                        )}
                    </CardBody>
