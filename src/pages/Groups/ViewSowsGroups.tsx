...
import { FaArrowDown, FaArrowUp, FaBalanceScale, FaLayerGroup, FaPiggyBank, FaVenus, FaWeight } from "react-icons/fa";
...
const ViewSowsGroups = () => {
    ...
    return (
        <div className="page-content">
            <Container fluid>
                <BreadCrumb title={t('groups.view.titleSows')} pageTitle={t('groups.pageTitle.replacement')} />
